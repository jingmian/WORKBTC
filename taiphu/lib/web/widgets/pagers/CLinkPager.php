...
class CLinkPager extends CBasePager {
    ...
    public function init() {
        ...
        if ($this->firstPageLabel === null)
            $this->firstPageLabel = Yii::t('yii', '<i class="fa fa-angle-left"></i>');
        if ($this->lastPageLabel === null)
            $this->lastPageLabel = Yii::t('yii', '<i class="fa fa-angle-right"></i>');
        if ($this->header === null)
    ...
    protected function createPageButton($label, $page, $class, $hidden, $selected) {
        ...
        return '<a class="' . $class . '">' . CHtml::link($label, $this->createPageUrl($page)) . '</a>';
    }
