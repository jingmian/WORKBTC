        ...
        if ($this->module->debug) {
            if (Yii::app()->request->isPostRequest) {
                if ($db = Yii::app()->db) {
                    ...
                    $db->createCommand(sprintf('drop table if exists %s, %s, %s, %s, %s, %s, %s, `%s`, %s, %s', $categoryTable, $productsTable, $orderTable, $customerTable, $imageTable, $variationTable, $taxTable, $shippingMethodTable, $paymentMethodTable, $specificationTable)
                    )->execute();
