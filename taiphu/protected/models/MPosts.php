 ...
 */
class MPosts extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('parent,product_id, name_vi, slug', 'required'),
            array('parent,product_id, status', 'numerical', 'integerOnly' => true),
            ...
            array('id, parent,product_id, name, slug, des, content, status, image, title, description, keyword, created_date, updated_date', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('product_id', $this->parent);
