 ...
 */
class MNewsLetter extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, name_vi, slug, des, content, status, image, title, description, keyword, created_date, updated_date', 'safe', 'on' => 'search'),
        );
    }
