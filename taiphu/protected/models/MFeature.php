 ...
 */
class MFeature extends CActiveRecord {
    ...
    public function getAllConfig() {
        if (!Yii::app()->cache->get('feature')) {
            Yii::app()->cache->set('feature', CHtml::listData($this->findAll(), 'id', 'status'));
        }
        return Yii::app()->cache->get('feature');
    }
