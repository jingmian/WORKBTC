 ...
 */
class MCategories extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('parent, status,active,number', 'numerical', 'integerOnly' => true),
            ...
            array('id, parent, name, slug, des, content, status,number,active, image, title, description, keyword, created_date, updated_date', 'safe', 'on' => 'search'),
        );
    }
