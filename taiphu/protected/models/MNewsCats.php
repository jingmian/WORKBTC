...
/**
 * This is the model class for table "{{newscats}}".
 *
 * The followings are the available columns in table '{{newscats}}':
 * @property integer $id
 ...
 */
class MNewsCats extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('parent, status,number,homepage', 'numerical', 'integerOnly' => true),
            ...
            array('id, parent,homepage,number, name, slug, des, content, status, image, title, description, keyword, created_date, updated_date', 'safe', 'on' => 'search'),
        );
    }
