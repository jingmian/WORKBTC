...
/**
 * This is the model class for table "{{propperty}}".
 *
 * The followings are the available columns in table '{{propperty}}':
 * @property integer $id
 ...
 */
class MPropperty extends CActiveRecord {
    ...
    public function getAllProducts() {
        return MProducts::model()->findAll('status=:status', array(':status' => 1));
    }
