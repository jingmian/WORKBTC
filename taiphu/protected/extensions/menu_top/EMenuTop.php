...
class EMenuTop extends CWidget {
                                ...
                                <li>
                                    ...
                                    foreach ($subMenuProduct as $keyM => $valS):
                                        ...
                                        <a href="<?= $subLink; ?>" title="<?= CHtml::encode($subItem->$subName); ?>">
                                            <?= CHtml::encode($subItem->$subName); ?><span style='background-image:url(http://thegioianhsang.vn/multidata/den-trang-tri-hot.jpg)'></span>
                                        </a>
