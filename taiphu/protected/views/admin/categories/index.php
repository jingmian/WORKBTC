            ...
            if ($models):
                ...
                foreach ($models as $keyM => $valueM):
                    ...
                    <tr>
                        ...
                        <td>
                            <?= intval($valueM['active']) == 1 ? 'Hiển thị' : 'Đình chỉ'; ?>
                        </td>
                        ...
                        <td><?= CHtml::dropDownList('active', $valueM['active'], array('none-active', 'Active'), array('class' => 'setHomePage', 'data-link' => $this->createUrl('setHomePage', array('id' => $valueM['id'])))); ?></td>
