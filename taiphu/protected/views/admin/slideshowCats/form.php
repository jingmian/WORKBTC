...
<div class="col-md-4">
    ...
    <div class="form-group">
        ...
        ?>
        <img class="img-select img-responsive img-thumbnail" src="<?= $img; ?>" alt="Chọn hình" onclick="selectImage('#MSlideshowCats_image');" />
...
<script>
    jQuery(function() {
        $('#MSlideshowCats_image').bind('change', function() {
